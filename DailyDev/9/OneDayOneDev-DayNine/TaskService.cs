...
namespace OneDayOneDev_DayFive
{
    ...
    public class TaskService
    {
       ...
       public OperationResult ExportToCSV(List<TaskItem> TaskToExport,MenuInfo TypeOfExport)
       {
        ...
        public OperationResult UpdateTask(int identifiant, string NewTitle, string NewDueDate, bool NewIscompleted)
        {
            var task = GetTaskById(identifiant);
            ...
            {
                task.DueDate = ParseDate(NewDueDate);
            }
